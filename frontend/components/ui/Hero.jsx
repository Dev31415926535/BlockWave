        ...
        <div className="mx-auto max-w-6xl py-32 sm:py-36 lg:py-40">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300 max-w-3xl mx-auto">
              Track every step of your product's journey - from manufacturing to the retailer—on an immutable ledger.
            </p>
            
            {/* Call to action buttons */}
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link href="/create" className="rounded-md bg-indigo-600 px-5 py-3 text-base font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900">
                Get Started
              </Link>
              <Link href="#features" className="rounded-md bg-transparent px-5 py-3 text-base font-semibold text-gray-100 ring-1 ring-white ring-opacity-25 hover:bg-white hover:text-black hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-40">
                Learn More
              </Link>
            </div>
...
export default ProductChainHero;